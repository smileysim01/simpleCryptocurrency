...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Rishabh', amount = 1)
...
def is_valid():
    ...
    if is_valid:
        ...
        response = {'message': 'Oops. There appears to be a problem. Blockchain is not valid.'}
    return jsonify(response), 200
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The Simcoin Blockchain now contains the following nodes:',
